            ...
            return DataTables::of($data)
                ...
                ->editColumn('is_confirm', function ($data) {
                    if ($data->is_confirm == 1) {
                        ...
                        return '<span class="badge bg-warning text-black">Unconfirmed</span>';
                    }
                })
                    ...
                    $actionBtn = '
                        <div class="text-center" width="10%">
                            <div class="btn-group">
                                ...
                                <a href="' . route('admin.articles.edit', $data->uuid) . '"  class="btn btn-sm btn-info text-white">
                                    <i class="fas fa-edit"></i>
                                </a>';

                                    if (request()->user()->hasRole('owner')) {
                                        $confirmBtn = $data->is_confirm ? 'btn-warning' : 'btn-success';
                                        $confirmIcon = $data->is_confirm ? 'fa-times' : 'fa-check';
                                        $actionBtn .= '
