...
class ArticleController extends Controller
{
    ...
    /**
     * fungsi ini untuk toggle is_confirm (Apakah artikel di telah dikonfirmasi atau belum, jika belum dikonfirmasi maka artikel tidak akan muncul di halaman utama, kita harus konfirmasi terlebih dahulu)
     */
