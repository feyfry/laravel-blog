                            ...
                            <div class="row g-4 align-items-center features-item">
                                <div class="col-4">
                                    <div class="rounded-circle position-relative">
                                        <div class="overflow-hidden rounded-circle border border-2 border-primary" style="width: 100px; height: 100px;">
                                            <img src="{{ asset('storage/images/'.$articles->image) }}"
                                                class="img-zoomin img-fluid w-100 h-100 object-fit-cover" alt="{{ $articles->title }}">
                                        </div>
                                        <span
