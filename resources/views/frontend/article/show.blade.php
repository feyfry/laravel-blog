                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade show active">
                                <div class="row g-4 align-items-center">
                                    <div class="col-3">
                                        <img src="https://i.ibb.co.com/ftS1gJ5/Yoru-Glow-Icon.jpg" class="img-fluid w-100 rounded"
                                            alt="">
                                    </div>
                                    <div class="col-9">
                                        <h3>{{ $article->user->name }}</h3>
                                        <p class="mb-0">
                                            Seorang Fullstack Developer yang mampu mengelola pengembangan aplikasi dari frontend hingga backend. Dengan keahlian dalam pengembangan antarmuka pengguna yang responsif serta pengelolaan server dan database, saya dapat menangani seluruh aspek teknis dari sebuah aplikasi web.
                                        </p>
                                    </div>
                                </div>
                            </div>
