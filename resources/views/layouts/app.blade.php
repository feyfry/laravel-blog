        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav ms-auto pe-3 pt-2 pb-2 rounded">
                        @auth
                            <li class="nav-item btn btn-sm btn-dark">
                                <a class="nav-link" href="{{ route('home') }}"><i class="fa fa-chart-bar"></i>
                                    Dashboard</a>
                            </li>

                            <li
                                class="nav-item btn btn-sm btn-dark {{ request()->is('admin/articles*') ? 'active' : '' }}">
                            ...
                            @if (auth()->user()->role == 'owner')
                                <li
                                    class="nav-item btn btn-sm btn-dark {{ request()->is('admin/categories*') ? 'active' : '' }}">
                                ...
                                <li
                                    class="nav-item btn btn-sm btn-dark {{ request()->is('admin/tags*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.tags.index') }}"><i class="fa fa-tag"></i>
                                        Tag</a>
                                </li>

                                <li class="nav-item btn btn-sm btn-dark {{ request()->is('admin/writers*') ? 'active' : '' }}">
